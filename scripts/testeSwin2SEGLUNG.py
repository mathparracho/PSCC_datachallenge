...
for epoch in range(max_epochs):
    ...
    save_ckp(checkpoint, True, "./models/modelSwinSEGLUNG.pt", "./models/modelSwinSEGLUNG.h5")
    
    #via das duvidas se bugar o checkpoint...
    model.eval()
    torch.save(model, "modelSwinSEGLUNG.h5")

    if epoch+1 == 1 or epoch+1 == 5 or epoch+1 == 10 or epoch+1 == 15 or epoch+1 == 20:
        model.eval()
        pathName = "./models/"+"model" + str(epoch+1) + "SwinSEGLUNG.h5"
