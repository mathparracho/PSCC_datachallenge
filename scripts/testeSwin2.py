...
train_files, val_files = data_dicts[:-90], data_dicts[-90:] # before was 20
print(train_images)
...
for epoch in range(max_epochs):
    ...
    if (epoch + 1) % val_interval == 0:
        ...
        with torch.no_grad():
            ...
            f = open("valLossesSWINFINAL.txt", "a")
    ...
    model.eval()
    torch.save(model, "modelSWINFINAL.h5")

    if epoch+1 in range(50):
        model.eval()
        pathName = "./models/"+"model" + str(20+epoch+1) + "SWINFINAL.h5"
        ...
        save_ckp(checkpoint, True, "./models/"+"model" + str(epoch+1) + "SWINFINALCKP.h5", "./models/model50SwinT2.h5")
