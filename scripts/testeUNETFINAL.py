...
for epoch in range(max_epochs):
    ...
    if (epoch + 1) % val_interval == 0:
        ...
        with torch.no_grad():
            ...
            f = open("valLossesUNETFINAL.txt", "a")
    ...
    model.eval()
    torch.save(model, "modelUNETFINAL.h5")

    if epoch+1 in range(50):
        model.eval()
        pathName = "./models/"+"model" + str(epoch+1) + "UNETFINAL.h5"
        ...
        save_ckp(checkpoint, True, "./models/"+"model" + str(epoch+1) + "UNETFINALCKP.h5", "./models/asfsdfadf.h5")
